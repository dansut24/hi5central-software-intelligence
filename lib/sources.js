export const STARTER_SOURCES = [
  ...
  metadata: {
    ...
    versionPattern: "vlc-([0-9]+\\.[0-9]+\\.[0-9]+)-win",
  ...
  source_name: "FileZilla Versions Page",
  source_type: "vendor_html",
  metadata: {
  ...
  metadata: {
    ...
    versionPattern: "putty-([0-9]+\\.[0-9]+)-installer",
